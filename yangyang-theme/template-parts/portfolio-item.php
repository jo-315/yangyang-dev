...
<div class="portfolio_item">
  <a href='#portfolio_modal_<?php echo $ID ?>' class="portfolio_modal">
    <img data-src=<?php echo $image->guid ?> class="lazyload" alt="<?php echo $image->post_content ?>"/>
  </a>
</div>

<div id="portfolio_modal_<?php echo $ID ?>" style="display:none;">
  <div class="portfolio_modal_img_wrap">
    <img data-src=<?php echo $image->guid ?> class="portfolio_modal_main_img lazyload" alt="<?php echo $image->post_content ?>" />
